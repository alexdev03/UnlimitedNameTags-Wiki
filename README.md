...
> \[!NOTE] This is the documentation for **UnlimitedNameTags v2.x (current)**. If you are using the legacy version 1.x, please refer to the [v1 Wiki](v1/).
...
* [**Migration Guide**](migration.md): Upgrading from legacy configuration structures (v1.x) to v2.x.

### 🛠️ How-To Guides

* [**Display Groups**](features/display-groups.md): Learn how to stack lines, adjust layouts, and use custom text, items, or blocks.
* [**Animations**](features/animations.md): Add physical movement, colors, and dynamic gradients to name tags.
* [**Show While Looking**](features/show-while-looking.md): Display name tags dynamically based on viewer crosshair target.
* [**Advanced Configuration**](features/advanced-yml.md): Fine-tune custom name tag height offsets using `advanced.yml`.
* [**Placeholder Replacements**](features/placeholders-replacements.md): Clean and map raw PlaceholderAPI (PAPI) outputs.

### 📚 Reference Manuals

* [**Configuration Reference**](configuration.md): A detailed breakdown of every main `settings.yml` option.
* [**Commands & Permissions**](commands-permissions.md): Full list of `/unt` command usage and permission nodes.
* [**Developer API**](api/): Java API integration for addon plugins documentation for custom developers.
* [**Integrations**](integrations/integrations.md): External plugin compatibility details (Nexo, Oraxen, Geyser, etc.).
...
* [**Limitations**](limitations.md): Known compatibility constraints, plugin conflicts, and upstream bugs.
