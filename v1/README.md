...
1. [Overview](./#overview) ­ƒôØ
2. [Requirements](./#requirements) ­ƒôï
3. **Features** Ô£¿
   * [Advanced (`advanced.yml`)](features/advanced-yml.md) ­ƒºó
   * [Animations](features/animations.md) ­ƒÄ¿
   * [Billboards](features/billboards.md) ­ƒÄÑ
   * [LineGroups](features/linesgroups.md) ­ƒÅÀ´©Å
   * [Placeholder replacements](features/placeholders-replacements.md) ­ƒöä
   * [Show while looking](features/show-while-looking.md) ­ƒæÇ
