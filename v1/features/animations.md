...
## ­ƒîê **Available Placeholders for Animations**
...
The same phase values are exposed for **PlaceholderAPI** as `%unt_phase-mm%`, `%unt_phase-md%`, `%unt_phase-mm-g%`, `%unt_-phase-mm%`, and `%unt_-phase-md%` (see [Integrations ÔåÆ PlaceholderAPI](../integrations/integrations.md#placeholderapi)).
